...
Write a function `numLines` whose parameters are a filename and a character, and prints out the number of lines in the file that start with that character.
